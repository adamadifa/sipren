                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-0 text-muted size-12">
                                            {{ $simpananpokok == null ? '' : $simpananpokok->no_anggota }}</p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-0 text-muted size-12">
                                            {{ $simpananwajib == null ? '' : $simpananwajib->no_anggota }}4</p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-0 text-muted size-12">{{ $simsuk == null ? '' : $simsuk->no_anggota }}
                                        </p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <p class="mb-0 text-muted size-12">
                                                    {{ $d->no_rekening == null ? '' : $d->no_rekening }}</p>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col align-self-center ps-0">
                                        <p class="text-color-theme mb-0" style="font-size:15px">
                                            {{ Gethari($d->presence_date) }}</p>
