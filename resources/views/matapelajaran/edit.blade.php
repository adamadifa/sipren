...
@section('page-pretitle', 'Edit Data Mata Pelajaran')
...
@section('content')
    <div class="row">
        <div class="col-md-4">
            <div class="card mt-2">
                <div class="card-body">
                    <form action="/matapelajaran/{{ Crypt::encrypt($matapelajaran->kode_matpel) }}/update" method="post" id="formMataPelajaran">
                        @csrf
                        @method('PUT')
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <x-inputnolabel label="Kode Mata Pelajaran" placeholder="Kode Mata Pelajaran" field="kode_matpel" readonly
                                    value="{{ $matapelajaran->kode_matpel }}" disabled="true"
