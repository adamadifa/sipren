  ...
  <div class="col-md-6">
    <div class="card mt-2">
      <div class="card-body">
        ...
        <input type="hidden" name="kodebiaya" id="kodebiaya" placeholder="Kode Biaya" class="form-control"
          value="{{$biaya->kodebiaya}}">
        <input type="hidden" name="jenjang" id="jenjang" placeholder="Jenjang" class="form-control"
          value="{{$biaya->jenjang}}">
        <input type="hidden" name="tingkat" id="tingkat" placeholder="Tingkat" class="form-control"
          value="{{$biaya->jenjang}}">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="input-icon">
              ...
              <input type="text" name="jumlah_biaya" id="jumlah_biaya" style="text-align: right"
                placeholder="Jumlah Biaya" class="form-control">
            </div>
          </div>
          <div class="col-md-3">
            <a href="#" class="btn btn-primary" id="tambahkan" style="background-color:#004c2d; color:white">
