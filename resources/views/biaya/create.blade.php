    ...
    <div class="card mt-2">
      <div class="card-body">
        <form action="/biaya" method="post" id="frmBiaya">
                ...
                <div class="row mb-2">
                  <div class="col-md-12">
                    ...
                    <div class="input-icon">
                      ...
                      <input type="text" name="kodebiaya" id="kodebiaya" placeholder="Kode Biaya" class="form-control"
                        readonly>
                    </div>
                  </div>
                </div>
          ...
          <button class="btn btn-primary" style="background-color:#004c2d; color:white" type="submit" name="submit">
