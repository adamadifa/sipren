...
@section('page-pretitle','Input Data Tahun Akademik')
@section('page-title','Input Data Tahun Akademik')
@section('content')
<div class="row">
  <div class="col-md-4">
    <div class="card mt-2">
      <div class="card-body">
        <form action="/tahunakademik" method="post">
          ...
          <div class="row mb-2">
            <div class="col-md-6">
              <x-inputtext label="" placeholder="0000" field="tahunakademik"
            ...
            <div class="col-md-6">
              <x-inputtext label="" placeholder="0000" field="tahunakademik2"
                icon='<!-- Download SVG icon from http://tabler-icons.io/i/file-invoice -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><line x1="9" y1="7" x2="10" y2="7" /><line x1="9" y1="13" x2="15" y2="13" /><line x1="13" y1="17" x2="15" y2="17" /></svg>' />
            </div>
          </div>
...
<script>
  $(function(){
    $("#tahunakademik").on('keyup', function () {
      var ta = $(this).val();
      var ta2 = parseInt(ta) + parseInt(1);
      if(ta !==""){
      $("#tahunakademik2").val(ta2);
      }else{
        $("#tahunakademik2").val("");
      }
    });
