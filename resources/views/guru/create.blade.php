...
@section('page-pretitle', 'Input Data Guru')
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <form action="/guru/store" method="post" id="formGuru">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <x-inputnolabel label="Kode Guru" placeholder="Kode Guru" field="kode_guru"
                                    icon='<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><line x1="9" y1="7" x2="10" y2="7" /><line x1="9" y1="13" x2="15" y2="13" /><line x1="13" y1="17" x2="15" y2="17" /></svg>' />
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <x-inputnolabel label="Nama Guru" placeholder="Nama Guru" field="nama_guru"
                                    icon='<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><line x1="9" y1="7" x2="10" y2="7" /><line x1="9" y1="13" x2="15" y2="13" /><line x1="13" y1="17" x2="15" y2="17" /></svg>' />
                            </div>
                        </div>
                        <div class="form-group">
                            <x-inputnolabel label="Alamat" placeholder="Alamat" field="alamat"
                                icon='
                        ...
                        <div class="form-group">
                            <x-inputnolabel label="No Telepon" placeholder="No Telepon" field="no_telepon"
