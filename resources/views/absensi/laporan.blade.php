...
@section('title','Laporan Absensi SDM')
@section('page-pretitle','Laporan Absensi SDM')
@section('page-title','Laporan Absensi SDM')
@section('content')
<div class="row mt-3">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form id="frmLaporan" action="/absensi/cetak" method="POST" target="_blank">
                    @csrf
