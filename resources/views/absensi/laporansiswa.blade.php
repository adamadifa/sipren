...
@section('page-pretitle','Laporan Presensi Siswa')
@section('page-title','Laporan Presensi Siswa')
@section('content')
<div class="row mt-3">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form id="frmLaporan" action="/absensi/cetaksiswa" method="POST" target="_blank">
                    @csrf
