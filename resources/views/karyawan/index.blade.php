                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="grid-container2">
                                        <div class="grid-item">
                                            <a href="/karyawan/{{ $d->npp }}/edit" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
                                            <a href="/karyawan/{{ $d->npp }}" class="btn btn-sm btn-info"><i class="fa fa-list"></i></a>
