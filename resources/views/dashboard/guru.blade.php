                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="/presensisiswa/{{ Crypt::encrypt($d->kode_jadwal) }}/create" class="btn btn-sm btn-info mr-2"><i
                                                        class="fa fa-list"></i></a>
                                                <a href="/presensisiswa/{{ Crypt::encrypt($d->kode_jadwal) }}/cetak" class="btn btn-sm btn-success mr-2"
                                                    target="_blank"><i class="fa fa-print"></i></a>
                                                <form action="/jadwalpelajaran/{{ $d->kode_jadwal }}/delete" method="post">
                                                    @csrf
                                                    @method('DELETE')
