<div class="collapse navbar-collapse" id="navbar-menu">
    <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ set_show(['karyawan','karyawan/create','unit']) }}"
            ...
            <div
                ...
                <a class="dropdown-item  {{ request()->is(['karyawan','karyawan/*']) ? 'active' : '' }}"
                    href="/karyawan">
                    Karyawan
                </a>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['pendaftaran/*']) ? 'show' : '' }}"
                href="#navbar-extra" data-toggle="dropdown" role="button"
                aria-expanded="{{ request()->is(['pendaftaran/*']) ? 'true' : '' }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/database -->
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ set_show(['checkingibadah']) }}" href="#navbar-extra"
                data-toggle="dropdown" role="button" aria-expanded="{{ set_true(['checkingibadah']) }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ set_show(['tahunakademik','tahunakademik/create']) }}"
                href="#navbar-extra" data-toggle="dropdown" role="button"
                aria-expanded="{{ set_true(['tahunakademik','tahunakademik/create']) }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
            ...
            <div class="dropdown-menu {{ set_show(['tahunakademik','tahunakademik/create','biaya','biaya/create']) }}">
                <a class="dropdown-item {{ set_active(['tahunakademik','tahunakademik/create']) }}"
                    href="/tahunakademik">
                    Tahun Akademik
                </a>
