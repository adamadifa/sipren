<div class="collapse navbar-collapse" id="navbar-menu">
    <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ set_show(['karyawan','karyawan/create','unit']) }}" href="#navbar-extra" data-toggle="dropdown" role="button" aria-expanded="{{ set_true(['karyawan','karyawan/create','unit']) }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
            ...
            <div class="dropdown-menu  {{ request()->is(['siswa','siswa/*','jenisbayar','jenisbayar/*','karyawan','karyawan/*']) ? 'show' : '' }}">
                <a class="dropdown-item  {{ request()->is(['karyawan','karyawan/*']) ? 'active' : '' }}" href="/karyawan">
                    Karyawan
                </a>
                <a class="dropdown-item {{ set_active(['siswa','siswa/create','siswa/cari']) }} {{ request()->is('siswa/*') ? 'active' : '' }}" href="/siswa">
                    Siswa
                </a>
                <a class="dropdown-item {{ set_active('unit') }}" href="/unit">
                    Unit
                </a>
                <a class="dropdown-item {{ set_active(['jenisbayar','jenisbayar/create']) }} {{ request()->is('jenisbayar/*') ? 'active' : '' }}" href="/jenisbayar">
                    Jenis Bayar
                </a>
            </div>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['pendaftaran/*']) ? 'show' : '' }}" href="#navbar-extra" data-toggle="dropdown" role="button" aria-expanded="{{ request()->is(['pendaftaran/*']) ? 'true' : '' }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/database -->
            ...
            <div class="dropdown-menu {{ request()->is(['pendaftaran/*']) ? 'show' : '' }}">
                ...
                <a class="dropdown-item {{ request()->is(['pendaftaran/SDIT','pendaftaran/SDIT/*']) ? 'active' : '' }}" href="/pendaftaran/SDIT">
                    SDIT
                </a>
                <a class="dropdown-item {{ request()->is(['pendaftaran/MDU','pendaftaran/MDU/*']) ? 'active' : '' }}" href="/pendaftaran/MDU">
                    MDU
                </a>
                <a class="dropdown-item {{ request()->is(['pendaftaran/MTS','pendaftaran/MTS/*']) ? 'active' : '' }}" href="/pendaftaran/MTS">
                    MTs
                </a>
                <a class="dropdown-item {{ request()->is(['pendaftaran/MA','pendaftaran/MA/*']) ? 'active' : '' }}" href="/pendaftaran/MA">
                    MA
                </a>
                <a class="dropdown-item {{ request()->is(['pendaftaran/ASRAMA','pendaftaran/ASRAMA/*']) ? 'active' : '' }}" href="/pendaftaran/ASRAMA">
                    ASRAMA
                </a>
            </div>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['absensi/*']) ? 'show' : '' }}" href="#navbar-extra" data-toggle="dropdown" role="button" aria-expanded="{{ request()->is(['absensi/*']) ? 'true' : '' }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/database -->
                    <!-- Download SVG icon from http://tabler-icons.io/i/user-check -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="dropdown-menu {{ request()->is(['absensi/*']) ? 'show' : '' }}">
                <a class="dropdown-item {{ request()->is(['absensi/karyawan','absensi/karyawan/*']) ? 'active' : '' }}" href="/absensi/karyawan">
                    Karyawan
                </a>
            </div>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['checklistibadah/*']) ? 'show' : '' }}" href="#navbar-extra" data-toggle="dropdown" role="button" aria-expanded="{{ request()->is(['checklistibadah/*']) ? 'true' : '' }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/database -->
                    <!-- Download SVG icon from http://tabler-icons.io/i/user-check -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="dropdown-menu {{ request()->is(['checklistibadah/*']) ? 'show' : '' }}">
                <a class="dropdown-item {{ request()->is(['checklistibadah/karyawanlist','checklistibadah/karyawan/*']) ? 'active' : '' }}" href="/checklistibadah/karyawanlist">
                    Karyawan
                </a>
            </div>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ set_show(['checkingibadah']) }}" href="#navbar-extra" data-toggle="dropdown" role="button" aria-expanded="{{ set_true(['checkingibadah']) }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['laporanpembayaran',
                ]) ? 'show' : '' }}" href="#navbar-extra" data-toggle="dropdown" role="button" aria-expanded="">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/file-text -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="dropdown-menu {{ request()->is(['laporanpembayaran','laporantagihan'
                ]) ? 'show' : '' }}">
                <a class="dropdown-item {{ request()->is(['laporanpembayaran',
                    ]) ? 'active' : '' }}" href="/laporanpembayaran">
                    Lap. Pembayaran
                </a>
                <a class="dropdown-item {{ request()->is(['laporantagihan',
                    ]) ? 'active' : '' }}" href="/laporantagihan">
                    Lap. Tagihan
                </a>
            </div>
