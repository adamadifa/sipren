...
@section('title')
Input Pendaftaran {{$jenjang}} Tahun Akademik {{$ta->tahunakademik}}
@endsection
        ...
        <div class="col-md-6">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <x-inputtext label="Tangal Pendaftaran" placeholder="Tanggal Pendaftaran" field="tgl_pendaftaran" icon='<!-- Download SVG icon from http://tabler-icons.io/i/calendar-event -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><rect x="8" y="15" width="2" height="2" /></svg>' />
                        </div>
                    </div>
                    <div id="showdatasiswa"></div>
                    <a href="#" id="batalkan" class="btn btn-danger"><i class="fa fa-history mr-2"></i>Batalkan</a>
                    <div id="datasiswa">
                        <div class="row mb-2">
                            <div class="col-md-8">
                                <x-inputtext label="Nama Lengkap" placeholder="Nama Lengkap" field="nama_lengkap" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><circle cx='12' cy='7' r='4' /><path d='M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' /></svg>" />
                            </div>
                            <div class="col-md-4">
                                <label for="" class="form-label" style="color:white">Cari Siswa</label>
                                <a href="#" id="carisiswa" class="btn btn-primary" style="background-color:#004c2d; color:white">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <x-inputtext label="Tempat Lahir" placeholder="Tempat Lahir" field="tempat_lahir" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><path d='M10.828 9.828a4 4 0 1 0 -5.656 0l2.828 2.829l2.828 -2.829z' /><line x1='8' y1='7' x2='8' y2='7.01' /><path d='M18.828 17.828a4 4 0 1 0 -5.656 0l2.828 2.829l2.828 -2.829z' /><line x1='16' y1='15' x2='16' y2='15.01' /></svg>" />
                            </div>
                            <div class="col-md-6">
                                <x-inputtext label="Tanggal Lahir" placeholder="Tanggal Lahir" field="tanggal_lahir" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><rect x='4' y='5' width='16' height='16' rx='2' /><line x1='16' y1='3' x2='16' y2='7' /><line x1='8' y1='3' x2='8' y2='7' /><line x1='4' y1='11' x2='20' y2='11' /><rect x='8' y='15' width='2' height='2' /></svg>" />
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-3">
                                <x-inputtext label="Anak Ke" placeholder="Anak Ke" field="anak_ke" icon="<!-- Download SVG icon from http://tabler-icons.io/i/users -->
                <svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><circle cx='9' cy='7' r='4' /><path d='M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' /><path d='M16 3.13a4 4 0 0 1 0 7.75' /><path d='M21 21v-2a4 4 0 0 0 -3 -3.85' /></svg>" />
                            </div>
                            <div class="col-md-3">
                                <x-inputtext label="Jumlah Saudara" placeholder="Jumlah Saudara" field="jml_saudara" icon="<!-- Download SVG icon from http://tabler-icons.io/i/users -->
                <svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><circle cx='9' cy='7' r='4' /><path d='M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' /><path d='M16 3.13a4 4 0 0 1 0 7.75' /><path d='M21 21v-2a4 4 0 0 0 -3 -3.85' /></svg>" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group  @error('id_propinsi') is-invalid @enderror">
                                    <select name="id_propinsi" id="id_propinsi" class="form-select  @error('id_propinsi') is-invalid @enderror">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <select name="id_kecamatan" id="id_kecamatan" class="form-select @error('id_kecamatan') is-invalid @enderror">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group @error('id_kelurahan') is-invalid @enderror">
                                    <select name="id_kelurahan" id="id_kelurahan" class="form-select @error('id_kelurahan') is-invalid @enderror">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <x-inputtext label="Kode Pos" placeholder="Kode Pos" field="kodepos" icon="<!-- Download SVG icon from http://tabler-icons.io/i/float-right -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <div id="datakeluarga">
                                <div class="row mb-2">
                                    <div class="col-md-8">
                                        <x-inputtext label="No KK" placeholder="No KK" field="no_kk" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><path d='M4 7v-1a2 2 0 0 1 2 -2h2' /><path d='M4 17v1a2 2 0 0 0 2 2h2' /><path d='M16 4h2a2 2 0 0 1 2 2v1' /><path d='M16 20h2a2 2 0 0 0 2 -2v-1' /><rect x='5' y='11' width='1' height='2' /><line x1='10' y1='11' x2='10' y2='13' /><rect x='14' y='11' width='1' height='2' /><line x1='19' y1='11' x2='19' y2='13' /></svg>" />
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-8">
                                        <x-inputtext label="NIK" placeholder="NIK" field="nik_ayah" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><path d='M4 7v-1a2 2 0 0 1 2 -2h2' /><path d='M4 17v1a2 2 0 0 0 2 2h2' /><path d='M16 4h2a2 2 0 0 1 2 2v1' /><path d='M16 20h2a2 2 0 0 0 2 -2v-1' /><rect x='5' y='11' width='1' height='2' /><line x1='10' y1='11' x2='10' y2='13' /><rect x='14' y='11' width='1' height='2' /><line x1='19' y1='11' x2='19' y2='13' /></svg>" />
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        <x-inputtext label="Nama Ayah" placeholder="Nama Ayah" field="nama_ayah" icon="<!-- Download SVG icon from http://tabler-icons.io/i/user -->
                    <svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><circle cx='12' cy='7' r='4' /><path d='M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' /></svg>" />
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group @error('pekerjaan_ayah') is-invalid @enderror">
                                            <select name="pekerjaan_ayah" id="pekerjaan_ayah" class="form-select @error('pekerjaan_ayah') is-invalid @enderror">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-8">
                                        <x-inputtext label="NIK" placeholder="NIK" field="nik_ibu" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><path d='M4 7v-1a2 2 0 0 1 2 -2h2' /><path d='M4 17v1a2 2 0 0 0 2 2h2' /><path d='M16 4h2a2 2 0 0 1 2 2v1' /><path d='M16 20h2a2 2 0 0 0 2 -2v-1' /><rect x='5' y='11' width='1' height='2' /><line x1='10' y1='11' x2='10' y2='13' /><rect x='14' y='11' width='1' height='2' /><line x1='19' y1='11' x2='19' y2='13' /></svg>" />
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        <x-inputtext label="Nama Ibu" placeholder="Nama Ibu" field="nama_ibu" icon="<!-- Download SVG icon from http://tabler-icons.io/i/user -->
                    <svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><circle cx='12' cy='7' r='4' /><path d='M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' /></svg>" />
                                    </div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group @error('pekerjaan_ibu') is-invalid @enderror">
                                            <select name="pekerjaan_ibu" id="pekerjaan_ibu" class="form-select @error('pekerjaan_ibu') is-invalid @enderror">
                ...
                <div class="col-md-12">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <x-inputtext label="NPSN" placeholder="NPSN" field="npsn" icon='<!-- Download SVG icon from http://tabler-icons.io/i/barcode -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7v-1a2 2 0 0 1 2 -2h2" /><path d="M4 17v1a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v1" /><path d="M16 20h2a2 2 0 0 0 2 -2v-1" /><rect x="5" y="11" width="1" height="2" /><line x1="10" y1="11" x2="10" y2="13" /><rect x="14" y="11" width="1" height="2" /><line x1="19" y1="11" x2="19" y2="13" /></svg>' />
                                </div>
                                <div class="col-md-8">
                                    <x-inputtext label="Asal Sekolah" placeholder="Asal Sekolah" field="asal_sekolah" icon='<!-- Download SVG icon from http://tabler-icons.io/i/building -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><line x1="3" y1="21" x2="21" y2="21" /><line x1="9" y1="8" x2="10" y2="8" /><line x1="9" y1="12" x2="10" y2="12" /><line x1="9" y1="16" x2="10" y2="16" /><line x1="14" y1="8" x2="15" y2="8" /><line x1="14" y1="12" x2="15" y2="12" /><line x1="14" y1="16" x2="15" y2="16" /><path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16" /></svg>' />
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <x-inputtext label="No. Ijazah" placeholder="No. Ijazah" field="no_ijazah" icon='<!-- Download SVG icon from http://tabler-icons.io/i/barcode -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7v-1a2 2 0 0 1 2 -2h2" /><path d="M4 17v1a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v1" /><path d="M16 20h2a2 2 0 0 0 2 -2v-1" /><rect x="5" y="11" width="1" height="2" /><line x1="10" y1="11" x2="10" y2="13" /><rect x="14" y="11" width="1" height="2" /><line x1="19" y1="11" x2="19" y2="13" /></svg>' />
                                </div>
                                <div class="col-md-6">
                                    <x-inputtext label="No. SHUN" placeholder="No. SHUN" field="no_shun" icon='<!-- Download SVG icon from http://tabler-icons.io/i/barcode -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7v-1a2 2 0 0 1 2 -2h2" /><path d="M4 17v1a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v1" /><path d="M16 20h2a2 2 0 0 0 2 -2v-1" /><rect x="5" y="11" width="1" height="2" /><line x1="10" y1="11" x2="10" y2="13" /><rect x="14" y="11" width="1" height="2" /><line x1="19" y1="11" x2="19" y2="13" /></svg>' />
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <x-inputtext label="No. Peserta Ujian" placeholder="No. Peserta Ujian" field="no_peserta_ujian" icon='<!-- Download SVG icon from http://tabler-icons.io/i/barcode -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7v-1a2 2 0 0 1 2 -2h2" /><path d="M4 17v1a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v1" /><path d="M16 20h2a2 2 0 0 0 2 -2v-1" /><rect x="5" y="11" width="1" height="2" /><line x1="10" y1="11" x2="10" y2="13" /><rect x="14" y="11" width="1" height="2" /><line x1="19" y1="11" x2="19" y2="13" /></svg>' />
                                </div>
                                <div class="col-md-3">
                                    <x-inputtext label="Rata Rata Nilai US" placeholder="Rata Rata Nilai US" field="nilai_us" icon='<!-- Download SVG icon from http://tabler-icons.io/i/barcode -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7v-1a2 2 0 0 1 2 -2h2" /><path d="M4 17v1a2 2 0 0 0 2 2h2" /><path d="M16 4h2a2 2 0 0 1 2 2v1" /><path d="M16 20h2a2 2 0 0 0 2 -2v-1" /><rect x="5" y="11" width="1" height="2" /><line x1="10" y1="11" x2="10" y2="13" /><rect x="14" y="11" width="1" height="2" /><line x1="19" y1="11" x2="19" y2="13" /></svg>' />
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <x-inputtext label="Tanggal Lulus" placeholder="Tanggal Lulus" field="tanggal_lulus" icon='<!-- Download SVG icon from http://tabler-icons.io/i/calendar-event -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="4" y="5" width="16" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="4" y1="11" x2="20" y2="11" /><rect x="8" y="15" width="2" height="2" /></svg>' />
                                </div>
                            </div>
                            <button class="btn btn-primary w-100" style="background-color:#004c2d; color:white" type="submit" name="submit">
...
<script>
    $(function() {
        ...
        function showdatasiswa() {
            ...
            $.ajax({
                ...
                , success: function(respond) {
                    $("#showdatasiswa").html(respond);
                }
            });
        }

        function showdatakeluarga() {
            var id_siswa = $("#id_siswa").val();
            $.ajax({
                type: 'POST'
                , url: '/loaddata/showdatakeluarga'
                , data: {
                    _token: "{{ csrf_token() }}"
                    , id_siswa: id_siswa
                }
        ...
        $('#example tbody').on('click', 'a', function() {
            ...
            $("#carisiswa").hide();
            $("#modal-carisiswa").modal("hide");
        });


        $("#carisiswa").click(function(respond) {
            $("#modal-carisiswa").modal("show");
        });
