        ...
        <div class="col-md-3">
          ...
          <div class="form-group">
            <select name="tahunakademik" class="form-select" id="">
              ...
              <option @if (!empty(Request::get('tahunakademik')))
                @if($t['tahunakademik']==Request::get('tahunakademik')) selected @endif @else
                @if($ta['tahunakademik']==$t['tahunakademik']) selected @endif @endif value="{{$t['tahunakademik']}}">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="table-responsive">
            ...
            <tr>
              ...
              <td>
                <div class="grid-container">
                  <div class="grid-item">
                    <a href="/pendaftaran/{{$jenjang}}/{{$p->no_pendaftaran}}/edit" class="btn btn-sm btn-primary"><i
                        class="fa fa-pencil"></i></a>
                    <a href="/pendaftaran/{{$jenjang}}/{{$p->no_pendaftaran}}/show" class="btn btn-sm btn-info"><i
                        class="fa fa-list"></i></a>
                  </div>
                  <div class="grid-item">
                    <form action="/pendaftaran/{{$jenjang}}/{{$p->no_pendaftaran}}/delete" id="deleteform"
                      method="post">
                      @csrf
                      @method('DELETE')
        ...
        <a href="/pendaftaran/{{$jenjang}}/create" class="btn btn-primary d-none mt-4 d-sm-inline-block mb-3"
