                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <select name="tahunakademik" class="form-select" id="">
                                ...
                                <option @if (!empty(Request::get('tahunakademik'))) @if ($t['tahunakademik'] == Request::get('tahunakademik')) selected @endif @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="grid-container">
                                            <div class="grid-item">
                                                <a href="/pendaftaran/{{ $jenjang }}/{{ $p->no_pendaftaran }}/edit"
