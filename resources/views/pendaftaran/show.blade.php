        ...
        <div class="card">
            ...
            <div class="d-flex">
                <a href="#" class="card-btn" style="background-color:#09482f; color:white">
                    ...
                    Ganti Foto</a>
                <a href="/pendaftaran/{{$pendaftaran->jenjang}}/{{$pendaftaran->no_pendaftaran}}/edit" class="card-btn" style="background-color: #ffb500; color:white ">
        ...
        <div class="card-body">
            <div class="card">
                <ul class="nav nav-tabs nav-fill" data-bs-toggle="tabs">
                    ...
                    <li class="nav-item">
                        <a href="#tabs-dokumen" class="nav-link" data-bs-toggle="tab">
                            <!-- Download SVG icon from http://tabler-icons.io/i/file-text -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M14 3v4a1 1 0 0 0 1 1h4" />
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tabs-dokumen">
                            <div class="row">
                                <div class="col-12">
                                    <form action="/pendaftaran/{{ Crypt::encrypt($pendaftaran->no_pendaftaran) }}/updatedokumen" method="POST" enctype="multipart/form-data" id="frmDokumen">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group  @error('kode_persyaratan') is-invalid @enderror">
                                                    <select name="kode_persyaratan" class="form-select  @error('kode_persyaratan') is-invalid @enderror" id="jenis_dokumen">
                                                        <option value="">Pilih Dokumen</option>
                                                        @foreach ($masterpersyaratan as $d)
                                                        <option value="{{ $d->kode_persyaratan }}">{{ $d->nama_persyaratan }}</option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <input type="file" class="form-control @error('dokumen') is-invalid @enderror"" name=" dokumen" id="dokumen">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <table class="table">
                                        ...
                                        @foreach ($datapersyaratan as $d)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $d->nama_persyaratan }}</td>
                                            <td>
                                                @if (!empty($d->file))
                                                @php
                                                $path = Storage::url('uploads/dokumen_pendaftaran/'.$d->file);
                                                @endphp
                                                <a href="{{ url($path) }}" target="_blank"><span class="badge bg-success">Lihat Dokumen</span></a>
                                                @else
