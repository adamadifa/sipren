...
<head>
    <title>Login | Sistem Informasi Pesantren Nurul Iman</title>
    <meta charset="utf-8">
            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo" style="margin-bottom:20px"><img src="{{ asset('klorofil/img/logo.png') }}" width="300"
                                        alt="Klorofil Logo">
                                </div>
                            ...
                            <form class="form-auth-small" action="{{ route('postlogin') }}" method="POST">
                                ...
                                <div class="bottom">
                                    <span class="helper-text"><i class="fa fa-lock"></i> Belum Punya Akun ? <a href="/daftar">Daftar</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">SISTEM INFORMASI PESANTREN NURUL IMAN</h1>
                            <p>Kp. Parakanpanjang Rt 001 Rw 002 Sukamanah Cigalontang</p>
                        </div>
                    </div>
