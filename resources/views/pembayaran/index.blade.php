        ...
        @else
            <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <option @if (Request::get('jenjang') == $j->nama_unit)
                        selected
                    @endif data-tingkat={{$j->jumlah_tingkat}} value="{{$j->nama_unit}}">{{$j->nama_unit}}</option>
                    @endforeach
                    </select>
                </div>
            </div>
          ...
          <table class="table bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/pembayaran/{{ \Crypt::encrypt($p->no_pendaftaran) }}/show" class="btn btn-primary btn-sm">
                    <i class="fa fa-eye"></i>
                  </a>
                </td>
              </tr>
