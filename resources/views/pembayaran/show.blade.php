    ...
    <div class="col-md-3">
        <div class="card">
            ...
            <div class="d-flex">
                ...
                <a href="/pendaftaran/{{$pembayaran->jenjang}}/{{$pembayaran->no_pendaftaran}}/edit" class="card-btn" style="background-color: #ffb500; color:white ">
...
<div class="row mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <button id="refreshpage" class="btn btn-primary"><i class="fa fa-history mr-2"></i> Refresh</button>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered table-hover" style="font-size:11px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="right" style="font-weight: bold">{{number_format($jmlbiaya,'0','','.')}}</td>
                                <td align="right" style="font-weight: bold">
                                    @if (!empty($d->jumlah_potongan))
                                    <a href="#" class="editpotongan" data-jenisbiaya="{{$d->jenisbayar}} {{$jenjang}} {{$ta}}" data-kodebiaya="{{$d->kodebiaya}}" data-idjenisbayar="{{$d->id_jenisbayar}}" data-jumlahpotongan="
                                        {{number_format($d->jumlah_potongan,'0','','.')}}">{{number_format($d->jumlah_potongan,'0','','.')}}</a>
                                    @else
                                    @if ($d->jenisbayar=="SPP")
                                    @if (!empty($d->no_rencana_spp))
                                    <a href="#" data-norencanaspp="{{$d->no_rencana_spp}}" class="btn btn-success btn-sm editspp">Edit SPP</a>
                                    @else
                                    <a href="/generatespp/{{\Crypt::encrypt($pembayaran->no_pendaftaran)}}/{{\Crypt::encrypt($d->kodebiaya)}}" class="btn btn-primary btn-sm">Generate SPP</a>
                                    @endif
                                    @elseif($d->jenisbayar=="Uang Lauk")
                                    @php
                                    $no_rencana_uanglauk = "";
                                    ...
                                    <a href="#" data-norencanaum="{{$d->no_rencana_um}}" class="btn btn-success btn-sm edituangmakan">Edit Uang Lauk</a>
                                    @else
                                    <a href="/generateuangmakan/{{\Crypt::encrypt($pembayaran->no_pendaftaran)}}/{{\Crypt::encrypt($d->kodebiaya)}}" class="btn btn-primary btn-sm">Generate</a>
                                    @endif
                                    @else
                                    <a href="#" class="btn btn-sm btn-danger tambahpotongan" data-jenisbiaya="{{$d->jenisbayar}} {{$jenjang}} {{$ta}}" data-kodebiaya="{{$d->kodebiaya}}" data-idjenisbayar="{{$d->id_jenisbayar}}"><i class="fa fa-gears"></i></a>
                                    @endif
                            ...
                            echo "<tr class='thead-dark'>
                                ...
                                <th style='text-align:right'>".number_format($totaltagihanperjenjang,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($totalpotonganperjenjang,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($grandtotaltagihanperjenjang,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($totalmutasiperjenjang,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($totalbayarperjenjang,'0','','.')."</th>
                            ...
                            echo "<tr style='background-color:#ffb500'>
                                ...
                                <th style='text-align:right'>".number_format($totalpotonganperta,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($grandtotaltagihanperta,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($totalmutasiperta,'0','','.')."</th>
                                <th style='text-align:right'>".number_format($totalbayarperta,'0','','.')."</th>
            ...
            <div class="modal-body">
                <form id="frmBayar" action="/pembayaran" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="input-icon">
                                ...
                                <input type="text" name="tgl_transaksi" id="tgl_transaksi" value="{{date(" Y-m-d")}}" placeholder="Tanggal Transaksi" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6" id="ppdb">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="jumlah_bayar" id="jumlah_bayar" value="" style="text-align: right" class="form-control">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="text" name="jumlah_spp" id="jumlah_spp" value="" style="text-align: right" class="form-control">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <button type="submit" class="btn btn-primary w-100" style="background-color:#09482f; color:white"><i class="fa fa-send mr-2"></i>
                            Simpan</button>
                    </div>
                </form>
            </div>
...
<div class="modal modal-blur fade" id="modal-potongan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span style="font-weight: bold" id="inputedit"></span> <span style="font-weight:bold" id="jenisbiayapotongan"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/simpanpotongan" method="POST">
                    ...
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" name="jumlah_potongan" placeholder="Jumlah Penyesuaian" id="jumlah_potongan" autocomplete="off" style="text-align: right" class="form-control">
                    </div>
...
<div class="modal modal-blur fade" id="modal-mutasi" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span style="font-weight: bold" id="inputeditmutasi"></span> <span style="font-weight:bold" id="jenisbiayamutasi"></span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/simpanmutasi" method="POST">
                    ...
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" name="jumlah_mutasi" placeholder="Jumlah Mutasi Manual" id="jumlah_mutasi" autocomplete="off" style="text-align: right" class="form-control">
                    </div>
                    <button type="submit" name="submit" class="btn btn-primary w-100">Simpan</button>
                </form>
            </div>
    ...
    $(function() {
        ...
        $("#tambah_bayar").click(function(e) {
            ...
            if (id_jenisbayar == "") {
                ...
                swal("Oops", "Pembayaran Melebihi Wajib Bayar ! Sisa Yang Harus Dibayarkan Sebesar " + wb, "warning");
            } else {
                $.ajax({
                    type: 'POST'
